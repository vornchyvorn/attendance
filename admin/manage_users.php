...
<main class="flex-1 ml-0 transition-all duration-300" :class="sidebarOpen ? 'ml-64' : 'ml-0'">
  ...
  <div class="container mx-auto mt-8 p-6 bg-white shadow-md rounded-md" 
    ...
    <div class="flex justify-between mb-4">
      ...
      <a href="../admin/add_user.php" class="bg-green-800 text-white px-4 py-2 rounded hover:bg-green-900 flex items-center gap-2 shadow">
  ...
  <table class="min-w-max w-full border-collapse text-sm text-center text-gray-700">
    <thead class="bg-green-800 text-white">
      <tr>
        ...
        <th class="border border-green-800 px-3 py-2 whitespace-nowrap">ថ្ងៃ / ខែ/ ឆ្នាំ</th>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
      ...
      <tr class="hover:bg-green-50 transition-colors"
        ...
        <td class="border border-gray-200 px-3 py-2 flex gap-2 justify-center">
          ...
          <!-- Delete -->
          <a href="delete_user.php?id=<?= $row['id'] ?>" class="text-red-600 hover:text-red-800 flex items-center gap-1"
             onclick="return confirm('តើអ្នកពិតជាចង់លុបទេ?');"><i class="fa-solid fa-trash"></i></a>
        </td>
      </tr>
      <?php endwhile; ?>
    </tbody>
    ...
    <form method="POST" action="update_user.php">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="mb-3">
          ...
          <input type="email" name="gmail" x-model="editUser.gmail"
                 class="w-full border px-3 py-2 rounded" required>
        </div>

        <div class="mb-3">
          <label class="block mb-1">ជំនាញ</label>
          <input type="text" name="major" x-model="editUser.major"
                 class="w-full border px-3 py-2 rounded" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" name="gender" x-model="editUser.gender"
                 class="w-full border px-3 py-2 rounded" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="date" name="date" x-model="editUser.date"
                 class="w-full border px-3 py-2 rounded" required>
        </div>

        <div class="mb-3">
          <label class="block mb-1">អាសយដ្ឋាន</label>
          <input type="text" name="address" x-model="editUser.address"
                 class="w-full border px-3 py-2 rounded" required>
        </div>
      </div>
